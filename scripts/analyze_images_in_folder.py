...
def analyze_images_in_folder(folder_path):
    ...
    if IMAGE_INFO.exists():
        print("IMAGES_INFO.json already exists! If you want to rerun analysis please delete it first!")
    else:
        print(f"Scanning folder: {folder_path}")
        supported_formats = (".jpg", ".jpeg", ".png")
        
        image_paths = [os.path.join(folder_path, fn) for fn in os.listdir(folder_path) if fn.lower().endswith(supported_formats)]
